...
class cube{
    public:
     ...
     void top_layer_plus_step4();

     int check_form_in_step5();
     void sqnce_in_step5();
     void position_toplayer_corners();

     void twisting_top_layer_corners();

     void sqnce_for_top_layer_edges();
     int check_form_in_lst_step();
     void top_layer_edges();
};
...
void cube::right_face_cw(int r){
   ...
   if(r==3){
     ...
     return;
      ...
      cout << "Rotate right face " << r << " times in clockwise direction\n";
   }
...
void cube:: right_face_acw(int r){
   if(r==3){
      right_face_cw(1);
      return;
   }else{
      cout << "Rotate right face " << r << " times in Anticlockwise direction\n";
   }
...
void cube::left_face_cw(int r){
   if(r==3){
      left_face_acw(1);
      return;
   }else{
      cout << "Rotate left face " << r << " times in clockwise direction\n";
   }
...
void cube::left_face_acw(int r){
   if(r==3){
      left_face_cw(1);
      return;
   }else{
      cout << "Rotate left face " << r << " times in Anticlockwise direction\n";
   }
...
void cube::top_face_cw(int r){
  if(r==3){
     top_face_acw(1);
     return;
  }else{
     cout << "Rotate top face " << r << " times in clockwise direction\n";
  }
...
void cube::top_face_acw(int r){
   if(r==3){
     top_face_cw(1);
     return;
  }else{
     cout << "Rotate top face " << r << " times in Anticlockwise direction\n";
  }
...
void cube::bottom_face_cw(int r){
  if(r==3){
     bottom_face_acw(1);
     return;
  }else{
     cout << "Rotate bottom face " << r << " times in clockwise direction\n";
  }
...
void cube::bottom_face_acw(int r){
  if(r==3){
     bottom_face_cw(1);
     return;
  }else{
     cout << "Rotate bottom face " << r << " times in Anticlockwise direction\n";
  }
...
void cube::front_face_cw(int r){
 if(r==3){
    front_face_acw(1);
    return;
 }else{
    cout << "Rotate front face " << r << " times in clockwise direction\n";
 }
...
void cube::front_face_acw(int r){
  if(r==3){
    front_face_cw(1);
    return;
 }else{
    cout << "Rotate front face " << r << " times in Anticlockwise direction\n";
 }
...
void cube::bottom_2layers_cw(int r){
   if(r==3){
      bottom_2layers_acw(1);
      return;
   }else{
      cout << "Rotate bottom 2 layers " << r << " times in clockwise direction\n";
   }
...
void cube::bottom_2layers_acw(int r){
   if(r==3){
      bottom_2layers_cw(1);
      return;
   }else{
      cout << "Rotate bottom 2 layers " << r << " times in Anticlockwise direction\n";
   }
...
void cube::face_2layers_cw(int r){
   if(r==3){
      face_2layers_acw(1);
      return;
   }else{
      cout << "Rotate face 2 layers " << r << " times in clockwise direction\n";
   }
...
void cube::face_2layers_acw(int r){
  if(r==3){
      face_2layers_cw(1);
      return;
   }else{
      cout << "Rotate face 2 layers " << r << " times in Anticlockwise direction\n";
   }
...
void cube::locate_origin(){//take white to top position
...
void cube::bottom_layer_corners(){
   int t=8;
   while(t--){
...
void cube::twisting_top_layer_corners(){
   rotate_upside_down();
  int t=8;
  while(t--){
    while((rubics_cube[5][7]==rubics_cube[3][5]) || (rubics_cube[1][9]==rubics_cube[3][5])){
      righty_alg(1);
    }
